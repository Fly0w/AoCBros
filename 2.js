const liste = `Game 1: 2 green, 6 blue, 7 red; 12 green, 6 blue, 3 red; 5 red, 18 green, 4 blue
...
const liste1 = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`

// const liste1 = `Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red`

const array = liste.split(`\n`);
...
//     let isOk = true
//     game.forEach((ball) => {
//         if((ball.includes("red") && (Number(ball.replace("red", ""))>12)) || 
//         (ball.includes("green") && (Number(ball.replace("green", ""))>13)) || 
//         (ball.includes("blue") && (Number(ball.replace("blue", ""))>14))){
//             isOk = false
//     }})
//     return isOk
// }
...
//     const indexColon = element.indexOf(":")
//     newEl = element.slice(indexColon + 2).replaceAll(";", ",").replaceAll(" ", "").split(",")

//     if(isPossibleGame(newEl)){
//         console.log("Game " + (index + 1) + " is OK")
//         total += (index + 1) 
//     }
// })
...
function minEach(game){
    let [red, green, blue] = [0,0,0]
    game.forEach((ball) => {
        if(ball.includes("red") && (Number(ball.replace("red", ""))>red)){
            red = Number(ball.replace("red", ""))
        } 
        if(ball.includes("green") && (Number(ball.replace("green", ""))>green)){
            green = Number(ball.replace("green", ""))
        } 
        if(ball.includes("blue") && (Number(ball.replace("blue", ""))>blue)){
            blue = Number(ball.replace("blue", ""))
        } 
    })
